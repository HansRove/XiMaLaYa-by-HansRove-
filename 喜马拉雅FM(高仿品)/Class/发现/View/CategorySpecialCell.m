...
- (UIImageView *)icon0 {
    if (!_icon0) {
        ...
        [_icon0 mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.size.mas_equalTo(CGSizeMake(kBigWidth, kBigWidth));
        }];
    }
    return _icon0;
}
- (UIImageView *)icon1 {
    if (!_icon1) {
        ...
        _icon1.backgroundColor = [UIColor yellowColor];
    }
    return _icon1;
}
- (UIImageView *)icon2 {
...
//            make.right.mas_equalTo(-10);
        ...
        _icon2.backgroundColor = [UIColor greenColor];
    }
    return _icon2;
}
- (UIImageView *)icon3 {
...
- (UIImageView *)icon4 {
    if (!_icon4) {
        ...
        _icon4.backgroundColor = [UIColor yellowColor];
    }
    return _icon4;
}
